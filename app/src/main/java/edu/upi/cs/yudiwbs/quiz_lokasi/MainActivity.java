...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    ArrayList<Lokasi>alLokasi = new ArrayList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alLokasi.add(new Lokasi("gik"));

        //Lokasi location = new Lokasi();
        //location.setLokasi(getLokasi());
        //alLokasi.add(Lokasi);

        rvLokasi = (RecyclerView) findViewById(R.id.rv_lokasi);
        rvLokasi.setHasFixedSize(true);
        adapter = new AdapterLokasi(alLokasi);
        lm = new LinearLayoutManager(this);
        rvLokasi.setAdapter(adapter);
        rvLokasi.setLayoutManager(lm);
    ...
    */
    ...
    public void onLocationChanged(Location location) {
        ...
        if (lat > -6.860427 &&  lat < -6.860237 && longi > 107.589595 && longi <  107.590111 )  {
            ...
            ad.show();
        } else if (lat > -6.861887  && lat < -6.861842 && longi > 107.589981 && longi < 107.590229 ) {
            AlertDialog ad = new AlertDialog.Builder(this).create();
            ad.setMessage("Di FPMIFA A");
            ad.show();
        } else {
            AlertDialog ad = new AlertDialog.Builder(this).create();
            ad.setMessage("Di Luar");
            ad.show();
        }
    }
}
